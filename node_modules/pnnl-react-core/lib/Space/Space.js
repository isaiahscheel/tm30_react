...
var Space = function (_React$Component) {
  (0, _inherits3['default'])(Space, _React$Component);
  ...
  function Space(props) {
    ...
    _this.state = {
      data: _this.props.space || undefined
    };
    return _this;
  }

  Space.prototype.componentDidMount = function componentDidMount() {
    var _this2 = this;
    ...
    if (this.props.id && !this.props.space) {
      _restApiHelper2['default'].GET(_config2['default'].opwhse.space(this.props.id), {
  ...
  Space.prototype.componentWillUnmount = function componentWillUnmount() {
  ...
  Space.prototype.render = function render() {
    ...
    var title = data.name === data.description ? data.facility.abbreviation + ' ' + data.name : data.description;
    var subTitle = data.name === data.description ? '' : data.facility.abbreviation + ' ' + data.name;

    var avatarComponent = _react2['default'].createElement(_Avatar2['default'], { src: data.thumbnailImage || _config2['default'].defaultSpaceImage, size: size });
    ...
    if (onClick) {
      return _react2['default'].createElement(
        'button',
        { className: 'PnnlSpace', onClick: onClick },
        avatarInfo
      );
    }
    return _react2['default'].createElement(
